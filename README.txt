...
For example:
The code for a project's 6.x-1.x-dev version is found in the 6.x-1.x Git branch.
...
To switch from master branch to the 6.x-1.x branch using Git on the command
