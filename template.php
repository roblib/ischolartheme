...
function ischolartheme_preprocess_page(&$vars, $hook) {
  ...
  $vars['site_slogan'] = $vars['site_slogan'] ? l($vars['site_slogan'], 'http://library.upei.ca', array('attributes' => array('rel' => 'Robertson Library', 'title' => 'Go to the Robertson Library'), 'html' => TRUE)) : '';
